...
//
// NOTE ON SCOPE: as drafted, both documents describe themselves as covering
// "the Cracker Wallet mobile applications, browser extensions and related
// websites" at cracker.global and crackerwallet.fun. They are linked from the
// footer of a site that also fronts the Launchpad, CrackerSwap and Egg Bot,
// which those definitions do not name. Broadening them is a legal change, not
// a copy edit, so it is left to LegalByte to reissue the documents with an
